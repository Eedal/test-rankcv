...
import useEpisode from "../core/hooks/useEpisode";
...
const Episodes = () => {
  try {
    const { item: episode, listResult: episodes, loading, error, select, handleSelect } =
    ...
    return (
      <MainLayout>
        ...
        <Grid container spacing={2}>
          <Grid item xs={3}>
            <Box mt={10} mb={2}>Select an episode</Box>
